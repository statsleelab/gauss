...
With the necessary arguments and data prepared, we can now estimate the Linkage Disequilibrium for a specific genomic region using the `computeLD()` function. For this example, we focus on a 1Mb genomic region located at Chr 22: 26M-27M.

```{r run_function, message=FALSE, warning=FALSE, results='hide'}
af1_cutoff = 0.001

res <- computeLD(chr=22, start_bp = 26000001, end_bp = 27000000,
