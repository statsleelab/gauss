...
```{r prep_mix_prop}
# Define path to the ancestry (ethnic mixing) proportion data file
anc_prop_file <- "data/pgc2_scz_anc_prop.RData"

# Load the ancestry proportion file
load(anc_prop_file) # data frame name: PGC2_SCZ_ANC_Prop=
...
res <- distmix(chr=22, start_bp = 26000001, end_bp = 27000000, wing_size = 500000,
