...
The GAUSS package depends on the GNU scientifiy library (GSL), so the users should install the gsl labrary first and then install the gauss pacakge. You can find the detailed explanation for this in this [link](https://statsleelab.github.io/gauss/articles/gsl_installation.html):
